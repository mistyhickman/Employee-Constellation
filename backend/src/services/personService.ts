...
export async function getPersonDetail(viewerId: string, viewerRoles: string[], targetPersonId: string) {
  ...
  return {
    ...
    birthdayMonth: visibility.basic ? person.birthdayMonth : null,
    birthdayDay: visibility.basic ? person.birthdayDay : null,
    homeCity: visibility.basic ? person.homeCity : null,
    homeState: visibility.basic ? person.homeState : null,
